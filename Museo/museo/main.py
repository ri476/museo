...
def main(page: ft.Page):
    ...
    def route_change(route):
                        ...
                        ft.Container(
                            ft.Column(
                                controls=[
                                    ...
                                    ElevatedButton(
                                        'la informatica durante el covid 19',
                                        on_click=lambda _: [StopAll(), page.go('/covid 19')]
                                    ),
                                    ElevatedButton(
        ...
        elif page.route == '/covid 19':
            page.views.append(
                View(
                    "/covid 19",
                    controls=[
                        AppBar(
                            title=ft.Text("la informatica durante el covid 19"),
                            bgcolor="gray"
                        ),
                        ft.Container(
                            ft.Column(
                        ...
                        ft.Container(
                            ft.Column(
                                controls=[
                                    ...
                                    ft.Text("LAS NUEVAS TECNOLOGIAS:"),
                                    # Aquí puedes agregar el contenido específico para la sección de lenguajes de programación
                                ],
                                alignment=ft.MainAxisAlignment.START
                            ),
